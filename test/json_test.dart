...
void main() {
  group('Can encode and decode', () {
    test('non-nullable fields', () {
      ...
      expect(a.customNullableStringSerialization, equals(CustomNullableStringSerialization(null)));
      expect(a.customMapSerializationField, CustomMapSerialization({'z': 'zzz'}));
    ...
    test('nullable fields with non-null values', () {
      ...
      expect(b.nullableDateTimeField, DateTime.parse('2024-11-11T03:42:29.108308'));
      ...
      expect(b.nullableCustomStringSerializationField, CustomStringSerialization('hi'));
      expect(b.nullableCustomMapSerializationField, CustomMapSerialization({'z': 'zzz'}));
    ...
    test('collections of nullable objects', () {
      ...
      expect(e.listOfNullableDates, equals([null, DateTime.parse('2024-11-11T03:42:29.108308')]));
      ...
      expect(e.listOfCustomStringSerializables[1], CustomStringSerialization('hi'));
      expect(e.listOfCustomMapSerializables.first, null);
      expect(e.listOfCustomMapSerializables[1], CustomMapSerialization({'z': 'zzz'}));

      expect(e.setOfNullableDates, equals([null, DateTime.parse('2024-11-12T03:42:29.108308')]));
      ...
      expect(e.setOfCustomStringSerializables.toList()[1], CustomStringSerialization('hi'));
      expect(e.setOfCustomMapSerializables.first, null);
      expect(e.setOfCustomMapSerializables.toList()[1], CustomMapSerialization({'z': 'zzz'}));
      ...
      expect(e.mapOfCustomStringSerializables['b'], CustomStringSerialization('hi'));
      expect(e.mapOfCustomMapSerializables['a'], null);
      expect(e.mapOfCustomMapSerializables['b'], CustomMapSerialization({'z': 'zzz'}));

      expect(e.toJson(), equals(json));
    });

    test(r'field with dollar sign $', () {
      // TODO: Fix this test by adding $ again
      var json = {
...
class CustomStringSerialization {
  ...
  factory CustomStringSerialization.fromJson(String a) => CustomStringSerialization(a);

  @override
  bool operator ==(Object other) => other is CustomStringSerialization && a == other.a;
...
class CustomNullableStringSerialization {
  ...
  factory CustomNullableStringSerialization.fromJson(String? a) => CustomNullableStringSerialization(a);

  @override
  bool operator ==(Object other) => other is CustomNullableStringSerialization && a == other.a;
...
class CustomMapSerialization {
  ...
  factory CustomMapSerialization.fromJson(Map<String, dynamic> a) => CustomMapSerialization(a);

  @override
  bool operator ==(Object other) {
    return other is CustomMapSerialization && a.toString() == other.a.toString();
  }
