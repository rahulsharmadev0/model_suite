import 'test/empty_class_test.dart' as empty_class_test;
import 'test/empty_nested_subclass_test.dart' as empty_nested_subclass_test;
import 'test/empty_subclass_of_named_multi_field_class_test.dart'
    as empty_subclass_of_named_multi_field_class_test;
import 'test/empty_subclass_of_named_single_field_class_test.dart'
    as empty_subclass_of_named_single_field_class_test;
import 'test/empty_subclass_of_nullable_named_single_field_class_test.dart'
    as empty_subclass_of_nullable_named_single_field_class_test;
import 'test/empty_subclass_of_nullable_optional_positional_single_field_class_test.dart'
    as empty_subclass_of_nullable_optional_positional_single_field_class_test;
import 'test/empty_subclass_of_nullable_positional_single_field_class_test.dart'
    as empty_subclass_of_nullable_positional_single_field_class_test;
import 'test/empty_subclass_of_optional_positional_single_field_class_test.dart'
    as empty_subclass_of_optional_positional_single_field_class_test;
import 'test/empty_subclass_of_positional_multi_field_class_test.dart'
    as empty_subclass_of_positional_multi_field_class_test;
import 'test/empty_subclass_of_positional_single_field_class_test.dart'
    as empty_subclass_of_positional_single_field_class_test;
import 'test/empty_subclass_test.dart' as empty_subclass_test;
import 'test/generic_single_field_class_test.dart' as generic_single_field_class_test;
import 'test/nullable_single_field_class_test.dart' as nullable_single_field_class_test;
import 'test/single_field_class_test.dart' as single_field_class_test;
import 'test/single_field_nested_subclass_of_positional_single_field_class_test.dart'
    as single_field_nested_subclass_of_positional_single_field_class_test;
import 'test/single_field_subclass_of_positional_single_field_class_test.dart'
    as single_field_subclass_of_positional_single_field_class_test;
import 'test/static_field_class_test.dart' as static_field_class_test;
